...
function initHeader(){
  let tl=gsap.timeline({delay:0.5});
    ...
    tl.from(".nav-btn__svg rect",{
        scale:0, tranformOrigin:"center right",
...
function initIntro(){
  ...
  //gTl.from(".intro_title .char",1,{})  -> 1 1초 duration을 의미
  gTl.from(".intro-img",1.5,{opacity:0, yPercent:100, stagger:0.6,})
...
function initSlides(){
  slides.forEach((slide, i) => {
    ...
    .from(slide.querySelectorAll('.slide-link_line'),{
